...
Call log:
  - waiting for getByTestId('custom-dropdown-toggle')
    - locator resolved to <button id="custom-dropdown-toggle" aria-label="Custom dropdown toggle" data-testid="custom-dropdown-toggle" class="btn-secondary practice-dropdown-toggle">Choose...</button>
      ...
      - generic [ref=e79]:
        ...
        - generic [ref=e204]:
          ...
          - generic [ref=e257]:
            ...
            - generic [ref=e260]:
              ...
              - generic [ref=e273]:
                ...
                - button "Custom dropdown toggle" [ref=e276] [cursor=pointer]: Choose...
                - paragraph [ref=e277]: "Selected: Choose..."
              - generic [ref=e278]:
          ...
          - generic [ref=e312]:
            ...
            - generic [ref=e315]:
              - paragraph [ref=e316]: Waiting for delayed element...
          ...
          - generic [ref=e326]:
            ...
            - generic [ref=e329]:
              - paragraph [ref=e330]: Loading spinner...
              - paragraph [ref=e331]: Waiting...
              - generic [ref=e332]:
...
> 24 |         await dropdown.selectOption(['Beta']);
     |                        ^ Error: locator.selectOption: Error: Element is not a <select> element
  25 |         await expect(dropdown).toHaveValue("Beta");
  26 |     });   
  27 | 
  28 | });
  29 | 
