...
Call log:
  ...
  - waiting for getByTestId('standard-select')
    13 × locator resolved to <select id="standard-select" name="standard-select" aria-label="Standard select" data-testid="standard-select" class="input-field practice-select">…</select>
